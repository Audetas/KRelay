...
{
    public class ClientStatAnnouncer : Plugin
    {
        ...
        {
            Message.Hook<ClientStat>(OnClientStat);
        }

        private void OnClientStat(Connection con, ClientStat clientStat)
        {
